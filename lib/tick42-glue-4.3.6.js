...
var main_3 = __webpack_require__(76);
var main_4 = __webpack_require__(64);
...
var GW3Bridge = (function () {
    ...
    GW3Bridge.prototype.handleUpdated = function (contextData, delta) {
        ...
        if (this._contextNameToData[contextData.name] === contextData &&
            ...
            this.invokeUpdateCallbacks(contextData, contextData.context, delta);
        }
    };
    ...
    GW3Bridge.prototype.handleContextUpdatedMessage = function (contextUpdatedMsg) {
        ...
        if (justSeen ||
            ...
            this.invokeUpdateCallbacks(contextData, contextData.context, null);
        }
    };
    GW3Bridge.prototype.invokeUpdateCallbacks = function (contextData, data, delta) {
        delta = delta || { added: {}, updated: {}, reset: {}, removed: [] };
        for (var updateCallbackIndex in contextData.updateCallbacks) {
            if (contextData.updateCallbacks.hasOwnProperty(updateCallbackIndex)) {
                try {
                    var updateCallback = contextData.updateCallbacks[updateCallbackIndex];
                    updateCallback(helpers_1.deepClone(data), Object.assign({}, delta.added || {}, delta.updated || {}, delta.reset || {}), delta.removed, parseInt(updateCallbackIndex));
                }
                catch (err) {
...
var ContextsModule = (function () {
    ...
    ContextsModule.prototype.subscribe = function (name, callback) {
        ...
        this.checkName(name);
        return this._bridge
            .subscribe(name, function (data, delta, removed, key) { return callback(data, delta, removed, function () { return _this._bridge.unsubscribe(key); }); })
            .then(function (key) {
            return function () {
...
var contextProvider_1 = __webpack_require__(62);
...
Object.defineProperty(exports, "__esModule", { value: true });
var layouts_1 = __webpack_require__(63);
var acsStream_1 = __webpack_require__(65);
var nullStream_1 = __webpack_require__(66);
var callback_registry_1 = __webpack_require__(1);
...
Object.defineProperty(exports, "__esModule", { value: true });
var gd_1 = __webpack_require__(71);
var hc_1 = __webpack_require__(73);
...
var executor_1 = __webpack_require__(70);
...
Object.defineProperty(exports, "__esModule", { value: true });
var CallbackFactory = __webpack_require__(1);
var group_1 = __webpack_require__(74);
var store_1 = __webpack_require__(3);
...
var groups_1 = __webpack_require__(75);
var store_1 = __webpack_require__(3);
exports.default = (function (agm, logger, appManagerGetter, gdMajorVersion) {
    var _registry = CallbackFactory();
    var _logger = logger;
